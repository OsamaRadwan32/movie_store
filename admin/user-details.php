              ...
              <div class="card-content">
                <div class="p-20">
                  ...
                  <div class="data-item clearfix">
                    ...
                    <div class="grid-70"><?php if ($results['gender'] == 'M') echo "Male"; else echo "Female"; ?></div>
                  </div>
                  <div class="data-item clearfix">
                    <div class="grid-30">Date of Birth</div>
                    <div class="grid-70"><?php $time = strtotime($results['date_of_birth']); echo date("d F, Y", $time); ?></div>
                  </div>
                  <div class="data-item clearfix">
